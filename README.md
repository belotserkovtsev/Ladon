...
- **Curated extensions** — готовые allow/deny-подборки (`ai`, `twitch`, `tiktok`, `ru`, ...) подключаются одной строкой в YAML
...
| `ru` | deny | gosuslugi.ru, mail.ru, vk.com, vk-analytics.ru — RU-сервисы, которым оффшорный VPN не нужен |
